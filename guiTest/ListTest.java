...
public class ListTest extends JFrame implements ActionListener,ItemListener{
	...
	public ListTest() {
		...
		btn.addActionListener(this); // 버튼을 ActionListener에 연결
		tf.addActionListener(this); // 텍스트입력창을 엔터를 눌러도 사용가능
		list.addItemListener(this);// 리스트를 ActionListener에 연결
		cb.addItemListener(this);// 체크박스를 ItemListener에 연결
